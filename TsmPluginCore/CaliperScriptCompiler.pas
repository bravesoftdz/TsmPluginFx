{/*! 
     \brief       Wraps up Gisdk resource compiler to enable just-in-time script compiling.
...
type
  ...
  public
    ...
    begin
      ...
      if File.Exists(lCompilerErrorFilePath) then aMessages := File.ReadLines(lCompilerErrorFilePath);
